...
/***/ function(module, exports, __webpack_require__) {
	...
	var createSelector = function createSelector(paths, getComputedValue) {
	  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	
	  var selectorCreator = (0, _utils.getSelectorCreator)(options);
	
	  if ((0, _isPlainObject2.default)(paths)) {
	    return (0, _utils.getStructuredSelector)(paths, selectorCreator);
	  }
	
	  if (!(0, _isArray2.default)(paths)) {
	    (0, _utils.throwInvalidPathsError)();
	  }
	
	  if (!paths.length) {
	    (0, _utils.throwNoPathsError)();
	  }
	
	  if (!(0, _isFunction2.default)(getComputedValue)) {
	    (0, _utils.throwInvalidComputedFunctionError)();
	  }
	
	  return (0, _utils.getStandardSelector)(paths, selectorCreator, getComputedValue);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.throwNoPathsError = exports.throwInvalidPathsError = exports.throwInvalidComputedFunctionError = exports.getStructuredSelector = exports.getStructuredObject = exports.getStandardSelector = exports.getSelectorCreator = exports.createIdentitySelector = exports.throwInvalidPathError = undefined;
	 ...
	 */
	var throwInvalidPathError = exports.throwInvalidPathError = function throwInvalidPathError() {
	 ...
	 */
	// external dependencies
	var createIdentitySelector = exports.createIdentitySelector = function createIdentitySelector(path) {
	 ...
	 */
	var getSelectorCreator = exports.getSelectorCreator = function getSelectorCreator(_ref) {
	  ...
	  var memoizerFn = memoizer || _reselect.defaultMemoize;
	
	  if (deepEqual) {
	    return _reselect.createSelectorCreator.apply(undefined, [memoizerFn, _isEqual2.default].concat(memoizerParams));
	  }
	
	  return (0, _isFunction2.default)(memoizer) || !!memoizerParams.length ? _reselect.createSelectorCreator.apply(undefined, [memoizerFn].concat(memoizerParams)) : _reselect.createSelector;
	};
	 ...
	 */
	var getStandardSelector = exports.getStandardSelector = function getStandardSelector(paths, selectorCreator, getComputedValue) {
	 ...
	 */
	var getStructuredObject = exports.getStructuredObject = function getStructuredObject(properties) {
	  return function () {
	 ...
	 */
	var getStructuredSelector = exports.getStructuredSelector = function getStructuredSelector(paths, selectorCreator) {
	 ...
	 */
	var throwInvalidComputedFunctionError = exports.throwInvalidComputedFunctionError = function throwInvalidComputedFunctionError() {
	  throw new TypeError('When building a standard selector, the second parameter passed must be a function, which ' + 'will receive the properties requested from state and return a computed value based on them.');
	};
	 ...
	 */
	var throwInvalidPathsError = exports.throwInvalidPathsError = function throwInvalidPathsError() {
	 ...
	 */
	var throwNoPathsError = exports.throwNoPathsError = function throwNoPathsError() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetCache = __webpack_require__(23),
	    arraySome = __webpack_require__(24),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var memoizeCapped = __webpack_require__(40);
