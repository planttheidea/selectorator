...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_identity__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isPlainObject__ = __webpack_require__(38);
...
var createSelector = function createSelector(paths) {
  ...
  var selectorCreator = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["a" /* getSelectorCreator */])(options);

  if (__WEBPACK_IMPORTED_MODULE_2_lodash_isPlainObject___default()(paths)) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["b" /* getStructuredSelector */])(paths, selectorCreator);
  }

  if (!__WEBPACK_IMPORTED_MODULE_1_lodash_isArray___default()(paths)) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["c" /* throwInvalidPathsError */])();
  }

  if (!paths.length) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["d" /* throwNoPathsError */])();
  }

  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__utils__["e" /* getStandardSelector */])(paths, selectorCreator, getComputedValue);
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isEqual__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_isString__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_get__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_reselect__ = __webpack_require__(43);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getStandardSelector; });
/* unused harmony export getStructuredObject */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getStructuredSelector; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return throwInvalidPathsError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return throwNoPathsError; });
// external dependencies
...
var createIdentitySelector = function createIdentitySelector(path) {
  if (__WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(path)) {
    return path;
  }

  if (!__WEBPACK_IMPORTED_MODULE_2_lodash_isString___default()(path)) {
    throwInvalidPathError();
  }

  return function (state) {
    return __WEBPACK_IMPORTED_MODULE_3_lodash_get___default()(state, path);
  };
};
...
var getSelectorCreator = function getSelectorCreator(_ref) {
  ...
  if (deepEqual) {
    return __WEBPACK_IMPORTED_MODULE_4_reselect__["createSelectorCreator"].apply(undefined, [memoizerFn, __WEBPACK_IMPORTED_MODULE_0_lodash_isEqual___default.a].concat(memoizerParams));
  }

  return memoizerParams.length || __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(memoizer) ? __WEBPACK_IMPORTED_MODULE_4_reselect__["createSelectorCreator"].apply(undefined, [memoizerFn].concat(memoizerParams)) : __WEBPACK_IMPORTED_MODULE_4_reselect__["createSelector"];
};
...
var getStandardSelector = function getStandardSelector(paths, selectorCreator, getComputedValue) {
  var selectors = paths.map(createIdentitySelector);
...
var baseIsEqualDeep = __webpack_require__(13),
...
var SetCache = __webpack_require__(7),
    arraySome = __webpack_require__(9),
    cacheHas = __webpack_require__(14);
...
var getAllKeys = __webpack_require__(19);
...
var baseIsEqual = __webpack_require__(12);
